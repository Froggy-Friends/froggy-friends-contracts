...
contract MarketBlock721A is
    ERC721A,
    Ownable,
    ReentrancyGuard,
    DefaultOperatorFilterer
{
    // Initial block list (can be update via add/remove functions below)
    address[] MarketplaceBlockList = [
        0x095be13D86000260852E4F92eA48dc333fa35249, // X2Y2 (Goerli)
        0xF8C81f3ae82b6EFC9154c69E3db57fD4da57aB6E // LooksRare TransferManagerERC721 (Goerli)
    ];
